...
write.xlsx(graph_data_out, paste0(out_dir, "TableS5.xlsx"), sheetName = "Thymic_Cell_Fisher_Test", col.names = TRUE, row.names = TRUE, append = TRUE)
...
ggsave(paste0(out_dir, "Figure5C.pdf"), width =12, height = 4)
```
