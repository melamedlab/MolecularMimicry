...
write.csv(testing_data %>%
            pivot_wider(names_from = mismatches, values_from = FC,
                        id_cols = c(Proteome.ID, Pathogen)), paste0(out_dir, "perm1_data_points.csv"))

wt <- compare_means(data = testing_data %>%
                      filter(Chronic.or.Acute %in% c("Acute", "Chronic")),
                    formula = FC ~ Chronic.or.Acute,
              group.by = c("mismatches"), method = "wilcox.test")%>%
  mutate(p.adj.star = ifelse(p.adj <= 0.001, "*\n*\n*", ifelse(p.adj <= 0.01, "*\n*",
                                                        ifelse(p.adj<=0.05, "*", NA))))
write.xlsx(wt, paste0(out_dir, "SupplementalData4.xlsx"), sheetName = "Perm1_Chronic_vs_Acute_Wilcox", col.names = TRUE, row.names = TRUE, append = FALSE)
...
gg3_perm1
write.csv(gg3_perm1$data, paste0(out_dir, "Figure3c_part1_datapoints.csv"))
testing_data <- random_scram_results %>%
  mutate(Proteome.ID = gsub(".*_UP", "UP", Species)) %>%
  left_join(metadata) %>%
...
write.xlsx(kt, paste0(out_dir, "SupplementalData4.xlsx"), sheetName = "Perm1_Viral_Family_Kruskal", col.names = TRUE, row.names = TRUE, append = TRUE)
write.xlsx(wt.p, paste0(out_dir, "SupplementalData4.xlsx"), sheetName = "Perm1_Pox_vs_Others_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
write.xlsx(wt.h, paste0(out_dir, "SupplementalData4.xlsx"), sheetName = "Perm1_Herpes_vs_Others_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
write.xlsx(wt.hp, paste0(out_dir, "SupplementalData4.xlsx"), sheetName = "Perm1_Herpes_vs_Pox_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
...
gg4_perm1
write.csv(gg4_perm1$data, paste0(out_dir, "Figure3c_part2_datapoints.csv"))
...
write.csv(testing_data %>%
            pivot_wider(names_from = mismatches, values_from = FC,
                        id_cols = c(Proteome.ID, Pathogen)), paste0(out_dir, "perm2_data_points.csv"))
...
wt <- compare_means(data = testing_data %>%
  ...
  mutate(p.adj.star = ifelse(p.adj <= 0.001, "*\n*\n*", ifelse(p.adj <= 0.01, "*\n*",
                                                        ifelse(p.adj<=0.05, "*", NA))))
write.xlsx(wt, paste0(out_dir, "SupplementalData4.xlsx"), sheetName = "Perm2_Chronic_vs_Acute_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
...
gg3_perm2 <- reverse_results %>%
  ...
  theme(legend.position = "none")
gg3_perm2
write.csv(gg3_perm2$data, paste0(out_dir, "Figure3d_part1_datapoints.csv"))
testing_data <- reverse_results %>%
  mutate(Proteome.ID = gsub(".*_UP", "UP", Species)) %>%
  left_join(metadata) %>%
  filter(!is.na(Family_Viral_Zone)) %>%
...
wt.hp <- compare_means(data = testing_data %>% filter(Family %in% c("Herpesviridae", "Poxviridae")), formula = FC ~ Poxviridae,
              group.by = c("mismatches"), method = "wilcox.test") %>%
  mutate(group1 = "Herpesviridae")
write.xlsx(kt, paste0(out_dir, "SupplementalData4.xlsx"), sheetName = "Perm2_Viral_Family_Kruskal", col.names = TRUE, row.names = TRUE, append = TRUE)
write.xlsx(wt.p, paste0(out_dir, "SupplementalData4.xlsx"), sheetName = "Perm2_Pox_vs_Others_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
write.xlsx(wt.h, paste0(out_dir, "SupplementalData4.xlsx"), sheetName = "Perm2_Herpes_vs_Others_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
write.xlsx(wt.hp, paste0(out_dir, "SupplementalData4.xlsx"), sheetName = "Perm2_Herpes_vs_Pox_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
...
gg4_perm2 <- reverse_results %>%
  ...
  theme(legend.position = "none")
gg4_perm2
write.csv(gg4_perm2$data, paste0(out_dir, "Figure3d_part2_datapoints.csv"))
```
...
write.csv(testing_data %>%
            pivot_wider(names_from = mismatches, values_from = FC,
                        id_cols = c(Proteome.ID, Pathogen)), paste0(out_dir, "perm3_data_points.csv"))

wt <- compare_means(data = testing_data %>%
  filter(Chronic.or.Acute %in% c("Acute", "Chronic")), formula = FC ~ Chronic.or.Acute,
              group.by = c("mismatches"), method = "wilcox.test")%>%
  mutate(p.adj.star = ifelse(p.adj <= 0.001, "*\n*\n*", ifelse(p.adj <= 0.01, "*\n*",
                                                        ifelse(p.adj<=0.05, "*", NA))))
write.xlsx(wt, paste0(out_dir, "SupplementalData4.xlsx"), sheetName = "Perm3_Chronic_vs_Acute_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
...
gg3_perm3 <- class_scram_results %>%
  ...
  theme(legend.position = "none")
gg3_perm3
write.csv(gg3_perm3$data, paste0(out_dir, "Figure3e_part1_datapoints.csv"))
...
write.xlsx(kt, paste0(out_dir, "SupplementalData4.xlsx"), sheetName = "Perm3_Viral_Family_Kruskal", col.names = TRUE, row.names = TRUE, append = TRUE)
write.xlsx(wt.p, paste0(out_dir, "SupplementalData4.xlsx"), sheetName = "Perm3_Pox_vs_Others_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
write.xlsx(wt.h, paste0(out_dir, "SupplementalData4.xlsx"), sheetName = "Perm3_Herpes_vs_Others_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
write.xlsx(wt.hp, paste0(out_dir, "SupplementalData4.xlsx"), sheetName = "Perm3_Herpes_vs_Pox_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
...
gg4_perm3 <- class_scram_results %>%
  ...
  theme(legend.position = "none")
gg4_perm3
write.csv(gg4_perm3$data, paste0(out_dir, "Figure3e_part2_datapoints.csv"))
```
