...
elm_filter = TRUE; elm_mode = "regex_motiff"
Sys.time()
files_to_read <- list.files()
files_to_read <- files_to_read[grepl(".csv.gz", files_to_read)]
...
for(active_file in files_to_read){
  ...
  if(elm_filter){
    if(elm_mode == "regex_motiff"){
      for(motiff_i in unique(elm_classes$Regex)){
        active_data <- active_data %>%
          filter(!grepl(motiff_i, paste0(".*", query, ".*")))
        ## browser()
      }
    } else if (elm_mode == "human_uniprot"){
...
gg2 <- heatdf %>% as.data.frame() %>%
  ...
  scale_fill_gradientn(colours = c("#045375", "#089099", "#7CCBA2",
                                   "#FCDE9C", "#FAB27B", "#E23333"), limits = c(-4,6.7),
                       na.value = "white") +
...
xlsx::write.xlsx(mismatch_data_meta, paste0(out_dir, "SupplementalData2.xlsx"), sheetName = "8mers", col.names = TRUE, row.names = TRUE)
...
xlsx::write.xlsx(wt, paste0(out_dir, "SupplementalData2.xlsx"), sheetName = "8mer_Chronic_vs_Acute_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
...
panel_c
write.csv(panel_c$data, paste0(out_dir, "Figure1c_datapoints.csv"))
```
...
xlsx::write.xlsx(kt, paste0(out_dir, "SupplementalData2.xlsx"), sheetName = "8mer_Viral_Family_Kruskal", col.names = TRUE, row.names = TRUE, append = TRUE)
xlsx::write.xlsx(wt.p, paste0(out_dir, "SupplementalData2.xlsx"), sheetName = "8mer_Pox_vs_Others_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
xlsx::write.xlsx(wt.h, paste0(out_dir, "SupplementalData2.xlsx"), sheetName = "8mer_Herpes_vs_Others_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
xlsx::write.xlsx(wt.hp, paste0(out_dir, "SupplementalData2.xlsx"), sheetName = "8mer_Herpes_vs_Pox_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
...
panel_d <- mismatch_data_meta %>%
  ...
  theme(legend.position = "none")
panel_d
write.csv(panel_d$data, paste0(out_dir, "Figure1d_datapoints.csv"))
```
...
xlsx::write.xlsx(mismatch_data_meta, paste0(out_dir, "SupplementalData2.xlsx"), sheetName = "12mers", col.names = TRUE, row.names = TRUE, append = TRUE)
...
wt <- compare_means(data = testing_data, formula = value ~ Chronic.or.Acute,
  ...
  mutate(p.adj.star = ifelse(p.adj <= 0.001, "*\n*\n*", ifelse(p.adj <= 0.01, "*\n*",
                                                        ifelse(p.adj<=0.05, "*", NA))))
xlsx::write.xlsx(wt, paste0(out_dir, "SupplementalData2.xlsx"), sheetName = "12mer_Chronic_vs_Acute_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
...
panel_e
write.csv(panel_e$data, paste0(out_dir, "Figure1e_datapoints.csv"))
```
...
wt.hp <- compare_means(data = testing_data %>% filter(Family %in% c("Herpesviridae", "Poxviridae")), formula = value ~ Poxviridae,
  ...
  mutate(p.adj.star = ifelse(p.adj <= 0.001, "*\n*\n*", ifelse(p.adj <= 0.01, "*\n*",
                                                        ifelse(p.adj<=0.05, "*", NA)))) %>%
  mutate(group1 = "Herpesviridae")
xlsx::write.xlsx(kt, paste0(out_dir, "SupplementalData2.xlsx"), sheetName = "12mer_Viral_Family_Kruskal", col.names = TRUE, row.names = TRUE, append = TRUE)
xlsx::write.xlsx(wt.p, paste0(out_dir, "SupplementalData2.xlsx"), sheetName = "12mer_Pox_vs_Others_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
xlsx::write.xlsx(wt.h, paste0(out_dir, "SupplementalData2.xlsx"), sheetName = "12mer_Herpes_vs_Others_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
xlsx::write.xlsx(wt.hp, paste0(out_dir, "SupplementalData2.xlsx"), sheetName = "12mer_Herpes_vs_Pox_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
...
panel_f <- mismatch_data_meta %>%
  ...
  scale_y_continuous(trans = log10_trans(),
     breaks = trans_breaks("log10", function(x) round(10^x, 3)))
panel_f
write.csv(panel_f$data, paste0(out_dir, "Figure1f_datapoints.csv"))
```
...
xlsx::write.xlsx(mismatch_data_meta, paste0(out_dir, "SupplementalData2.xlsx"), sheetName = "18mers", col.names = TRUE, row.names = TRUE, append = TRUE)
...
wt <- compare_means(data = testing_data, formula = value ~ Chronic.or.Acute,
  ...
  mutate(p.adj.star = ifelse(p.adj <= 0.001, "*\n*\n*", ifelse(p.adj <= 0.01, "*\n*",
                                                        ifelse(p.adj<=0.05, "*", NA))))
xlsx::write.xlsx(wt, paste0(out_dir, "SupplementalData2.xlsx"), sheetName = "18mer_Chronic_vs_Acute_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
...
panel_g <- mismatch_data_meta %>%
  ...
  theme(legend.position = "none")
panel_g
write.csv(panel_g$data, paste0(out_dir, "Figure1g_datapoints.csv"))
```
...
xlsx::write.xlsx(kt, paste0(out_dir, "SupplementalData2.xlsx"), sheetName = "18mer_Viral_Family_Kruskal", col.names = TRUE, row.names = TRUE, append = TRUE)
xlsx::write.xlsx(wt.p, paste0(out_dir, "SupplementalData2.xlsx"), sheetName = "18mer_Pox_vs_Others_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
xlsx::write.xlsx(wt.h, paste0(out_dir, "SupplementalData2.xlsx"), sheetName = "18mer_Herpes_vs_Others_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
xlsx::write.xlsx(wt.hp, paste0(out_dir, "SupplementalData2.xlsx"), sheetName = "18mer_Herpes_vs_Pox_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
panel_h <- mismatch_data_meta %>%
  ...
  theme(legend.position = "none")
panel_h
write.csv(panel_h$data, paste0(out_dir, "Figure1h_datapoints.csv"))
```
...
supp_panel_a <- mismatch_data_meta %>%
  ...
  annotation_logticks(sides = "l", size = 0.1)
supp_panel_a
write.csv(supp_panel_a$data, paste0(out_dir, "FigureS1a_datapoints.csv"))
```
...
supp_panel_b <- mismatch_data_meta %>%
  ...
  annotation_logticks(sides = "l", size = 0.1) 
supp_panel_b
write.csv(supp_panel_b$data, paste0(out_dir, "FigureS1b_datapoints.csv"))
```
...
supp_panel_c <- mismatch_data_meta %>%
  ...
  annotation_logticks(sides = "l", size = 0.1)
supp_panel_c
write.csv(supp_panel_c$data, paste0(out_dir, "FigureS1c_datapoints.csv"))
```
...
Supplemental Figure 1D-I are in the FigureS1_ELMFilter.qmd file also in the Figure 1 folder.

Supplemental Figure 1J is in the FigureS1_Mouse_vs_Human.qmd
...
write.csv(ggS2B[["data"]], paste0(out_dir, "FigureS2B_datapoints.csv"))
```
...
write.csv(AA_freq %>%
  ...
  pivot_wider(names_from = amino_acid, values_from = percent, id_cols = virus) %>%
  left_join(metadata %>% dplyr::select(Proteome.ID, Pathogen), by = c("virus" = "Proteome.ID")) %>% relocate(virus, Pathogen), paste0(out_dir, "FigureS2c_datapoints.csv"))
```
