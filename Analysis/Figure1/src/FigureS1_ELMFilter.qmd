...
xlsx::write.xlsx(mismatch_data_meta, paste0(out_dir, "SupplementalData3.xlsx"), sheetName = "8mers", col.names = TRUE, row.names = TRUE)
...
xlsx::write.xlsx(wt, paste0(out_dir, "SupplementalData3.xlsx"), sheetName = "8mer_Chronic_vs_Acute_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
...
panel_d
write.csv(panel_d$data, paste0(out_dir, "FigureS1d_datapoints.csv"))
```
...
xlsx::write.xlsx(kt, paste0(out_dir, "SupplementalData3.xlsx"), sheetName = "8mer_Viral_Family_Kruskal", col.names = TRUE, row.names = TRUE, append = TRUE)
xlsx::write.xlsx(wt.p, paste0(out_dir, "SupplementalData3.xlsx"), sheetName = "8mer_Pox_vs_Others_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
xlsx::write.xlsx(wt.h, paste0(out_dir, "SupplementalData3.xlsx"), sheetName = "8mer_Herpes_vs_Others_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
xlsx::write.xlsx(wt.hp, paste0(out_dir, "SupplementalData3.xlsx"), sheetName = "8mer_Herpes_vs_Pox_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
...
panel_e <- mismatch_data_meta %>%
  ...
  theme(legend.position = "none")
panel_e
write.csv(panel_e$data, paste0(out_dir, "FigureS1e_datapoints.csv"))
```
...
xlsx::write.xlsx(mismatch_data_meta, paste0(out_dir, "SupplementalData3.xlsx"), sheetName = "12mers", col.names = TRUE, row.names = TRUE, append = TRUE)
...
wt <- compare_means(data = testing_data, formula = value ~ Chronic.or.Acute,
  ...
  mutate(p.adj.star = ifelse(p.adj <= 0.001, "*\n*\n*", ifelse(p.adj <= 0.01, "*\n*",
                                                        ifelse(p.adj<=0.05, "*", NA))))
xlsx::write.xlsx(wt, paste0(out_dir, "SupplementalData3.xlsx"), sheetName = "12mer_Chronic_vs_Acute_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
...
panel_f
write.csv(panel_f$data, paste0(out_dir, "FigureS1f_datapoints.csv"))
```
...
wt.hp <- compare_means(data = testing_data %>% filter(Family %in% c("Herpesviridae", "Poxviridae")), formula = value ~ Poxviridae,
  ...
  mutate(p.adj.star = ifelse(p.adj <= 0.001, "*\n*\n*", ifelse(p.adj <= 0.01, "*\n*",
                                                        ifelse(p.adj<=0.05, "*", NA)))) %>%
  mutate(group1 = "Herpesviridae")
xlsx::write.xlsx(kt, paste0(out_dir, "SupplementalData3.xlsx"), sheetName = "12mer_Viral_Family_Kruskal", col.names = TRUE, row.names = TRUE, append = TRUE)
xlsx::write.xlsx(wt.p, paste0(out_dir, "SupplementalData3.xlsx"), sheetName = "12mer_Pox_vs_Others_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
xlsx::write.xlsx(wt.h, paste0(out_dir, "SupplementalData3.xlsx"), sheetName = "12mer_Herpes_vs_Others_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
xlsx::write.xlsx(wt.hp, paste0(out_dir, "SupplementalData3.xlsx"), sheetName = "12mer_Herpes_vs_Pox_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
...
panel_g <- mismatch_data_meta %>%
  ...
  scale_y_continuous(trans = log10_trans(),
     breaks = trans_breaks("log10", function(x) round(10^x, 3)))
panel_g
write.csv(panel_g$data, paste0(out_dir, "FigureS1g_datapoints.csv"))
```
...
xlsx::write.xlsx(mismatch_data_meta, paste0(out_dir, "SupplementalData3.xlsx"), sheetName = "18mers", col.names = TRUE, row.names = TRUE, append = TRUE)
...
wt <- compare_means(data = testing_data, formula = value ~ Chronic.or.Acute,
  ...
  mutate(p.adj.star = ifelse(p.adj <= 0.001, "*\n*\n*", ifelse(p.adj <= 0.01, "*\n*",
                                                        ifelse(p.adj<=0.05, "*", NA))))
xlsx::write.xlsx(wt, paste0(out_dir, "SupplementalData3.xlsx"), sheetName = "18mer_Chronic_vs_Acute_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
...
panel_h <- mismatch_data_meta %>%
  ...
  theme(legend.position = "none")
panel_h
write.csv(panel_h$data, paste0(out_dir, "FigureS1h_datapoints.csv"))
```
...
xlsx::write.xlsx(kt, paste0(out_dir, "SupplementalData3.xlsx"), sheetName = "18mer_Viral_Family_Kruskal", col.names = TRUE, row.names = TRUE, append = TRUE)
xlsx::write.xlsx(wt.p, paste0(out_dir, "SupplementalData3.xlsx"), sheetName = "18mer_Pox_vs_Others_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
xlsx::write.xlsx(wt.h, paste0(out_dir, "SupplementalData3.xlsx"), sheetName = "18mer_Herpes_vs_Others_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
xlsx::write.xlsx(wt.hp, paste0(out_dir, "SupplementalData3.xlsx"), sheetName = "18mer_Herpes_vs_Pox_Wilcox", col.names = TRUE, row.names = TRUE, append = TRUE)
panel_i <- mismatch_data_meta %>%
  ...
  theme(legend.position = "none")
panel_i
write.csv(panel_i$data, paste0(out_dir, "FigureS1i_datapoints.csv"))
```
